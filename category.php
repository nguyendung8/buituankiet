          ...
          <div class="col-md-9 order-2">
            ...
            <?php
              if(isset($_GET['trang'])){
                ...
                $begin = ($page*6)-6;
                  ...
                  $sql_show ="SELECT * FROM sanpham WHERE maloaiSP = $maloaiSP ORDER BY sanpham.maSP DESC LIMIT $begin,6";
            ...
            <div class="row" data-aos="fade-up">
              <div class="col-md-12 text-center">
                ...
                <?php
                     if(mysqli_num_rows($query_show)>0){
				          $sql_trang = mysqli_query($connect,"SELECT * FROM sanpham WHERE maloaiSP = $maloaiSP ORDER BY sanpham.maSP DESC LIMIT $begin,6");
                  ...
                  <?php
					        ...
					        ?>
					        <?php if($i==$page){ ?>
					            <li class ="active"><a href="category.php?trang=<?php echo $i ?>"><?php echo $i ?></a></li>
					        <?php } else { ?>
						          <li><a href="category.php?trang=<?php echo $i ?>"><?php echo $i ?></a></li>
					        <?php
					        } 
					        ?>
				<?php
