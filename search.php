            ...
            <?php
              if(isset($_GET['trang'])){
                ...
                if(isset($_GET['keyword'])){
                  ...
                  $sql_show ="SELECT * FROM sanpham s 
                  INNER JOIN loaiSP l ON s.maloaiSP = l.maloaiSP
                  INNER JOIN thuonghieu t ON s.maTH = t.maTH
                  WHERE s.tenSP LIKE '%".$keyword."%' OR  l.tenloaiSP LIKE '%".$keyword."%' OR  t.tenTH LIKE '%".$keyword."%' ORDER BY s.maSP DESC LIMIT $begin,6";
          ...
          <?php	
            ...
            <div class="row" data-aos="fade-up">
              <div class="col-md-12 text-center">
                ...
                <?php
                     if(mysqli_num_rows($query_show)>0){
				          $sql_trang = mysqli_query($connect,"SELECT * FROM sanpham s 
                          INNER JOIN loaiSP l ON s.maloaiSP = l.maloaiSP
                          INNER JOIN thuonghieu t ON s.maTH = t.maTH
                          WHERE s.tenSP LIKE '%".$keyword."%' OR  l.tenloaiSP LIKE '%".$keyword."%' OR  t.tenTH LIKE '%".$keyword."%' ORDER BY s.maSP DESC LIMIT $begin,6");
                  ...
                  <?php
					        ...
					        ?>
					        <?php if($i==$page){ ?>
					            <li class ="active"><a href="search.php?trang=<?php echo $i ?>"><?php echo $i ?></a></li>
					        <?php } else { ?>
						          <li><a href="search.php?trang=<?php echo $i ?>"><?php echo $i ?></a></li>
					        <?php
					        } 
					        ?>
				<?php
